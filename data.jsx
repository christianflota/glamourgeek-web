  ...
  aiServices: [
    {
      ...
      featured: true,
      metaTitle: “Automatización con Inteligencia Artificial para Empresas en México | GlamourGeek”,
      metaDesc: “Automatiza atención al cliente, ventas y procesos internos con IA en México. Flujos en n8n, Zapier, Make y WhatsApp. ROI medible en semanas.”,
      heroTagline: “Automatiza lo repetitivo. Escala lo que importa.”,
      longDesc: “La automatización con IA es el cambio operativo más rentable que puede hacer tu empresa hoy. En GlamourGeek diseñamos flujos inteligentes que conectan tus canales de comunicación, califican leads, responden clientes y mueven oportunidades por tu pipeline — sin intervención humana en cada paso.”,
      features: [
        { title: “Flujos con n8n, Zapier y Make”, desc: “Conectamos tus apps y canales en flujos automatizados: CRM, WhatsApp, email, hojas de cálculo, APIs y más.” },
        { title: “Respuesta automática a leads”, desc: “El sistema detecta un nuevo lead y responde en segundos con información personalizada, sin que intervenga tu equipo.” },
        { title: “Calificación de prospectos con GPT”, desc: “IA que analiza cada conversación y clasifica al prospecto según su intención de compra para priorizar el seguimiento.” },
        { title: “Recordatorios de pago y post-venta”, desc: “Secuencias automáticas de WhatsApp o email para cobros, recordatorios y fidelización sin esfuerzo manual.” },
        { title: “Integración con tu stack actual”, desc: “Funciona con las herramientas que ya usas: HubSpot, Kommo, Google Sheets, Notion, Shopify, MercadoPago y más.” },
      ],
      benefits: [“Ahorra 20+ horas semanales de operación”, “Responde leads en segundos, no en horas”, “Escala sin contratar más personal”, “ROI medible en las primeras semanas”],
      faq: [
        { q: “¿Cuánto tiempo tarda la implementación?”, a: “Un flujo de automatización básico puede estar operando en 1–2 semanas. Proyectos más complejos con múltiples integraciones: 4–6 semanas.” },
        { q: “¿Necesito saber programar para usarlo?”, a: “No. Construimos y documentamos todo. Te entregamos el sistema listo y te capacitamos para monitorearlo y hacer ajustes básicos.” },
        { q: “¿Qué pasa si el flujo falla?”, a: “Configuramos alertas y monitoreo. Ante cualquier fallo, nuestro equipo actúa y lo resuelve dentro del SLA acordado.” },
      ],
    },
    {
      id: “chatbots”,
      ...
      metaTitle: “Chatbots con Inteligencia Artificial para WhatsApp e Instagram | GlamourGeek”,
      metaDesc: “Desarrollamos chatbots con GPT para WhatsApp, Instagram y web en México. Atención 24/7, flujos de venta, cotización y reserva integrados con tu CRM.”,
      heroTagline: “Tu vendedor más disciplinado trabaja las 24 horas”,
      longDesc: “Un chatbot inteligente no es un menú de opciones — es un agente de ventas que entiende el lenguaje natural, responde en segundos y guía al cliente hasta la conversión. En GlamourGeek construimos chatbots con GPT entrenados con el contexto de tu negocio, integrados con tus canales y tu CRM.”,
      features: [
        { title: “Chatbot en WhatsApp Business API”, desc: “Atención automatizada en WhatsApp con flujos de venta, cotización y reserva. El canal preferido en México.” },
        { title: “Chatbot en Instagram y web”, desc: “Responde DMs de Instagram y consultas del chat web con el mismo motor de IA, sin duplicar esfuerzos.” },
        { title: “Entrenado con tu negocio”, desc: “El bot conoce tus servicios, precios, horarios y preguntas frecuentes. Las respuestas suenan a tu marca, no a un robot genérico.” },
        { title: “Integración con CRM”, desc: “Cada conversación calificada entra automáticamente a Kommo, HubSpot, o el CRM que uses, con la etapa correcta.” },
        { title: “Escalado a humano inteligente”, desc: “Cuando el bot detecta una conversación compleja, transfiere al agente correcto con todo el contexto de la conversación.” },
      ],
      benefits: [“Responde en menos de 5 segundos”, “Atiende sin horarios ni vacaciones”, “Convierte más leads con seguimiento automático”, “Libera a tu equipo para cierres complejos”],
      faq: [
        { q: “¿El chatbot puede hacer cotizaciones?”, a: “Sí. Configuramos flujos de cotización donde el bot recopila información, calcula el precio y envía una propuesta automática.” },
        { q: “¿Cómo se actualiza si cambian mis precios?”, a: “Te entregamos un panel donde puedes actualizar la información del bot sin conocimientos técnicos.” },
        { q: “¿Funciona en español mexicano?”, a: “Sí. El bot está entrenado en el contexto de tu negocio y el lenguaje de tu mercado, incluyendo modismos y expresiones locales.” },
      ],
    },
    {
      id: “crm-ai”,
      ...
      metaTitle: “CRM con Inteligencia Artificial para Ventas en México | GlamourGeek”,
      metaDesc: “Implementamos IA dentro de tu CRM para clasificar leads, priorizar cierres y automatizar el seguimiento. Compatible con HubSpot, Kommo y más.”,
      heroTagline: “Tu CRM que trabaja, prioriza y cierra por ti”,
      longDesc: “La mayoría de los CRM son bases de datos glorificadas. Con IA integrada, tu CRM se convierte en un copiloto de ventas que clasifica oportunidades, sugiere el siguiente paso, genera respuestas y resúmenes automáticos — para que tu equipo solo se enfoque en cerrar.”,
      features: [
        { title: “Clasificación automática de leads”, desc: “IA que analiza comportamiento, historial y conversaciones para asignar un score de probabilidad de cierre a cada lead.” },
        { title: “Priorización inteligente del pipeline”, desc: “El sistema identifica qué oportunidades están listas para avanzar y alerta a tu vendedor en el momento correcto.” },
        { title: “Generación de respuestas sugeridas”, desc: “GPT redacta el siguiente mensaje para cada prospecto basado en el contexto de la conversación, tu vendedor solo aprueba.” },
        { title: “Resúmenes automáticos de conversaciones”, desc: “Cada llamada, chat o email se resume automáticamente en el CRM para que cualquier vendedor pueda retomar el contexto.” },
        { title: “Alertas de riesgo de pérdida”, desc: “El sistema detecta leads inactivos o con señales de desinterés y alerta antes de que se pierda la oportunidad.” },
      ],
      benefits: [“Aumenta la tasa de cierre del equipo”, “Elimina el follow-up manual olvidado”, “Visibilidad total del pipeline en tiempo real”, “Onboarding de vendedores más rápido”],
      faq: [
        { q: “¿Con qué CRMs trabajan?”, a: “Principalmente con HubSpot, Kommo (AmoCRM), Salesforce y Pipedrive. Si usas otro, lo evaluamos en el diagnóstico.” },
        { q: “¿Necesito cambiar mi CRM actual?”, a: “No. La IA se integra sobre tu CRM existente como una capa adicional de inteligencia, sin migrar datos.” },
        { q: “¿Cuánto mejora la tasa de conversión?”, a: “Varía por industria, pero clientes típicos reportan 20–40% de mejora en tasa de cierre en los primeros 90 días.” },
      ],
    },
    {
      id: “content-ai”,
      ...
      metaTitle: “Generación de Contenido con IA para Marketing Digital | GlamourGeek”,
      metaDesc: “Creamos sistemas de generación de contenido con IA en México: posts para redes, blogs SEO, anuncios y emails. Producción a escala con voz de marca consistente.”,
      heroTagline: “Contenido de calidad a escala, sin perder tu voz de marca”,
      longDesc: “El contenido es el combustible del marketing digital, pero producirlo de forma consistente consume recursos enormes. Con IA configurada a tu marca, generamos copy para redes, artículos SEO, anuncios y emails a una fracción del costo y tiempo — sin sacrificar calidad ni identidad.”,
      features: [
        { title: “Sistema de contenido para redes sociales”, desc: “Generación de posts, captions y hashtags adaptados a cada red, en la voz de tu marca y con el calendario editorial integrado.” },
        { title: “Artículos de blog optimizados para SEO”, desc: “Contenido largo orientado a keywords de tu industria, estructurado para posicionar en Google y convertir al lector.” },
        { title: “Copy para anuncios (Google Ads y Meta)”, desc: “Variantes de anuncios generadas con IA y testeadas para maximizar CTR y conversiones en cada plataforma.” },
        { title: “Secuencias de email marketing”, desc: “Flujos de nurturing, onboarding, recuperación de carritos y re-engagement redactados y automatizados con IA.” },
        { title: “Entrenamiento con tu voz de marca”, desc: “El sistema aprende tu tono, estilo y palabras clave para que todo el contenido suene consistente con tu identidad.” },
      ],
      benefits: [“10x más producción al mismo costo”, “Consistencia de marca en todos los canales”, “Contenido listo para publicar, no borradores”, “Liberación del equipo para trabajo estratégico”],
      faq: [
        { q: “¿El contenido generado necesita revisión humana?”, a: “Recomendamos una revisión rápida antes de publicar, especialmente al inicio. Con el tiempo el sistema mejora y requiere menos edición.” },
        { q: “¿Funciona para cualquier industria?”, a: “Sí. Hemos generado contenido para turismo, salud, tecnología, retail, finanzas y servicios profesionales.” },
        { q: “¿Google penaliza el contenido generado con IA?”, a: “No si el contenido aporta valor real al usuario. Google penaliza contenido de baja calidad, no el uso de IA. Nuestro enfoque es siempre calidad + SEO.” },
      ],
    },
    {
      id: “consulting-ai”,
      ...
      metaTitle: “Consultoría de Inteligencia Artificial para Empresas en México | GlamourGeek”,
      metaDesc: “Diagnóstico y roadmap de IA para tu empresa en México. Identificamos los procesos con mayor potencial de automatización y diseñamos el plan de implementación con KPIs.”,
      heroTagline: “Sabe exactamente dónde y cómo implementar IA en tu negocio”,
      longDesc: “Antes de implementar IA, hay que saber dónde implementarla. En GlamourGeek hacemos un diagnóstico profundo de tu operación, identificamos los procesos con mayor retorno de inversión y diseñamos un roadmap por fases — realista, medible y alineado a tus recursos.”,
      features: [
        { title: “Diagnóstico de procesos”, desc: “Mapeo de tus operaciones actuales para identificar cuellos de botella, tareas repetitivas y oportunidades de automatización.” },
        { title: “Priorización por ROI”, desc: “Clasificamos cada oportunidad por impacto, viabilidad y tiempo de implementación para maximizar el retorno desde el inicio.” },
        { title: “Roadmap de implementación por fases”, desc: “Plan detallado con entregables, tiempos, tecnologías y KPIs para cada fase del proyecto de IA.” },
        { title: “Selección de herramientas”, desc: “Evaluamos y recomendamos las herramientas correctas para tu stack, presupuesto y equipo técnico.” },
        { title: “Acompañamiento en la implementación”, desc: “Nos quedamos contigo durante la ejecución para resolver obstáculos, ajustar el plan y medir resultados reales.” },
      ],
      benefits: [“Evita invertir en IA que no da resultados”, “Claridad sobre qué automatizar primero”, “Reducción de costos operativos medible”, “Implementación sin sorpresas ni sobrecostos”],
      faq: [
        { q: “¿Cuánto dura una consultoría?”, a: “El diagnóstico inicial dura 2–4 semanas. El roadmap completo con acompañamiento puede extenderse 3–6 meses según el alcance.” },
        { q: “¿Mi empresa necesita un equipo técnico propio?”, a: “No. Podemos trabajar directamente con tu equipo operativo o actuar como el equipo técnico externo para toda la implementación.” },
        { q: “¿Cuánto cuesta?”, a: “El diagnóstico inicial tiene un costo fijo desde $999 MXN (sesión de 30 min). Los proyectos completos se cotizan según el alcance definido.” },
      ],
    },
    {
      id: “api-ai”,
      ...
      metaTitle: “Integraciones con APIs de IA: OpenAI, Whisper y Vision | GlamourGeek”,
      metaDesc: “Desarrollamos sistemas personalizados sobre OpenAI, Whisper y Vision en México. Transcripción automática, análisis de imágenes y reportes generados con IA integrados en tu plataforma.”,
      heroTagline: “El poder de OpenAI integrado directamente en tu plataforma”,
      longDesc: “Las APIs de IA de OpenAI, Anthropic y Google son las más poderosas del mundo — pero integrarlas correctamente requiere arquitectura, experiencia y conocimiento del stack. En GlamourGeek construimos sistemas personalizados sobre estas APIs que agregan inteligencia real a tus productos y procesos.”,
      features: [
        { title: “Integración con OpenAI GPT-4o”, desc: “Conectamos GPT a tus sistemas para análisis de texto, generación de contenido, atención al cliente y decisiones automatizadas.” },
        { title: “Transcripción con Whisper”, desc: “Transcripción automática de llamadas, reuniones y mensajes de voz con alta precisión en español. Ideal para CRM y compliance.” },
        { title: “Análisis de imágenes con Vision”, desc: “Sistemas que extraen información de fotos, documentos escaneados, facturas o productos usando GPT Vision.” },
        { title: “Generación de reportes con IA”, desc: “Dashboards y reportes narrativos generados automáticamente a partir de tus datos — en lenguaje humano, no solo tablas.” },
        { title: “APIs custom sobre tu stack”, desc: “Construimos endpoints propios que envuelven las APIs de IA y se conectan con tu base de datos, backend o plataforma existente.” },
      ],
      benefits: [“IA directamente en tu producto o plataforma”, “Reducción de costos de operación manual”, “Diferenciación tecnológica vs competencia”, “Arquitectura escalable y mantenible”],
      faq: [
        { q: “¿Cuánto cuesta usar las APIs de OpenAI?”, a: “El costo de las APIs es por uso (tokens consumidos). Para la mayoría de casos de negocio, el costo mensual es de $50–$500 USD dependiendo del volumen.” },
        { q: “¿Pueden integrar con Anthropic o Google Gemini?”, a: “Sí. Trabajamos con OpenAI, Anthropic (Claude), Google Gemini y Mistral según el caso de uso y el presupuesto.” },
        { q: “¿Los datos de mi empresa están seguros?”, a: “Sí. Configuramos la integración con las mejores prácticas de seguridad. Las APIs tienen opciones de no retención de datos para casos sensibles.” },
      ],
    },
  ],
